...
if(playerChoice == 'rock' && computerChoice == 'scissors' ||
        ...
        playerChoice == 'paper' && computerChoice == 'rock'){
            ...
            humanSelection.setAttribute('src', `./assets/images/${playerChoice}_winner.png`);
            computerSelection.setAttribute('src', `./assets/images/${computerChoice}_default.png`);
            ...
            humanSelection.setAttribute('src', `./assets/images/${playerChoice}_default.png`);
            computerSelection.setAttribute('src', `./assets/images/${computerChoice}_winner.png`);
